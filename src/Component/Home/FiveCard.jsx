        ...
        <div className='container'>
            ...
            <div className='w-full flex justify-between items-center py-4 px-10  bg-linear-to-r  from-gray-800   via-stone-600  to-zinc-700  text-white rounded-lg mt-10 '>
                ...
                <div className='relative w-1/2'>
                    <input type="text" placeholder='Your email'  className='w-full text-xl py-3 px-5 bg-white text-black rounded-lg pr-35 border-0 outline-0'/>
                    <button className="px-5 py-2 text-black border border-gray-400 rounded-xl font-semibold flex gap-2 items-center text-[16px] hover:bg-button absolute top-1.5 right-1.5 ">Subscribe </button>
                </div>
            </div>
        </div>
    );
